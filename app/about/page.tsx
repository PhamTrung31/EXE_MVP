          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-white/90">
                Together - Nền tảng kết nối tình nguyện viên và các tổ chức
            ...
            <div className="max-w-4xl mx-auto">
              <Card className="p-8 md:p-12 border-0 bg-white/80 backdrop-blur-sm shadow-xl">
                ...
                <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                  Together được thành lập với sứ mệnh tạo ra một cầu nối giữa
                  những người có tấm lòng thiện nguyện và các tổ chức cần sự
                  giúp đỡ. Chúng tôi tin rằng mỗi người đều có thể tạo ra sự
                  thay đổi tích cực cho cộng đồng.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Thông qua nền tảng của mình, chúng tôi mong muốn khuyến khích
                  tinh thần tình nguyện, lan tỏa yêu thương và xây dựng một cộng
                  đồng đoàn kết, tương trợ lẫn nhau.
                </p>
              </Card>
            </div>
          </div>
            ...
            <div className="max-w-4xl mx-auto">
              <Card className="p-8 md:p-12 border-0 bg-white/80 backdrop-blur-sm shadow-xl">
                <p className="text-lg text-muted-foreground text-center leading-relaxed">
                  Together được vận hành bởi một đội ngũ trẻ, năng động và tràn
                  đầy nhiệt huyết. Chúng tôi đến từ nhiều lĩnh vực khác nhau
                  nhưng đều có chung một mục tiêu: tạo ra một nền tảng giúp kết
                  nối những trái tim nhân ái và lan tỏa điều tốt đẹp đến cộng
                  đồng.
                </p>
              </Card>
            </div>
