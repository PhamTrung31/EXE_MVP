...
export default function ProgramDetailPage({ params }: { params: Promise<{ id: string }> }) {
 ...
 Trạng thái:{" "}
 <span className={reg.status === "approved" ? "text-[#6085F0]" : "text-yellow-600"}>
 {reg.status === "approved" ? "Đã duyệt" : "Chờ duyệt"}
 </span>
 </p>
 </div>
 {reg.hoursContributed && (
 <p className="text-sm font-semibold text-[#6085F0]">{reg.hoursContributed} giờ</p>
 )}
 </div>
 ))
 ) : (
 ...
 <Button className="w-full bg-[#6085F0] hover:opacity-90 mb-3" asChild>
