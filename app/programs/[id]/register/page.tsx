...
export default function ProgramRegisterPage({ params }: { params: Promise<{ id: string }> }) {
 const { id } = use(params)
 ...
 Bạn cần đăng nhập với tài khoản tình nguyện viên để đăng ký tham gia chương trình này.
 </p>
 ...
 <p className="text-muted-foreground mb-6">
 Đơn đăng ký của bạn đã được gửi. Tổ chức sẽ xem xét và liên hệ với bạn sớm.
 </p>
 ...
 <Button variant="outline" asChild>
 <Link href={`/programs/${program.id}`}>Quay lại chương trình</Link>
 </Button>
 </div>
 </div>
 </Card>
 ...
 <h1 className="text-3xl font-bold text-foreground mb-2">Đăng ký tham gia</h1>
 ...
 {/* Skills */}
 <div>
 <label className="block text-sm font-semibold text-foreground mb-2">Kỹ năng</label>
 <input
 type="text"
 name="skills"
 ...
 <Button type="submit" className="flex-1 bg-[#6085F0] hover:opacity-90">
 Gửi đơn đăng ký
 </Button>
