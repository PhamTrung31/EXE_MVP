...
export default function OrganizationDetailPage({ params }: { params: Promise<{ id: string }> }) {
 ...
 <Button variant="ghost" asChild className="mb-6 hover:bg-[#77E5C8]/10">
 ...
 <p className="text-white/90">{selectedProgram.organizationName}</p>
 </div>
 <button
 onClick={() => setSelectedProgram(null)}
 ...
 <h4 className="font-semibold text-[#6085F0] mb-2">Mô tả trong nước</h4>
 ...
 <div className="text-center">
 <p className="text-2xl font-bold text-[#6085F0]">{approvedCount}</p>
