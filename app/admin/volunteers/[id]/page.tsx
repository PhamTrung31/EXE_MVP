...
export default function VolunteerDetailPage({ params }: { params: Promise<{ id: string }> }) {
 ...
 <p className="text-sm text-white/90">Chương trình đã tham gia</p>
 </div>
 </Card>
 ...
 return (
 <div key={reg.id} className="p-4 border border-border rounded-lg hover:bg-[#77E5C8]/10 transition">
 ...
 <div key={cert.id} className="p-4 border border-[#77E5C8] rounded-lg bg-[#77E5C8]/10">
 <div className="flex items-start justify-between mb-2">
