    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 flex items-center justify-center py-12">
        <Card className="w-full max-w-md p-8 border-emerald-200">
          <h1 className="text-3xl font-bold text-foreground mb-2">Đăng nhập Tổ chức</h1>
          <p className="text-muted-foreground mb-8">Đăng nhập vào tài khoản tổ chức của bạn</p>

          {isSubmitted ? (
            <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-6 text-center">
              <p className="text-emerald-700 font-semibold mb-4">Đăng nhập thành công!</p>
              <p className="text-muted-foreground mb-6">Chào mừng bạn quay trở lại</p>
              <Button className="w-full bg-emerald-600 hover:bg-emerald-700" asChild>
                <Link href="/organization/dashboard">Vào Dashboard</Link>
              </Button>
            </div>
          ) : (
          ...
          <div className="mt-6 text-center">
            <p className="text-muted-foreground">
              Chưa có tài khoản?{" "}
              <Link href="/auth/organization-signup" className="text-emerald-600 hover:text-emerald-700 font-semibold">
                Đăng ký ngay
              </Link>
            </p>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-border">
            ...
            <div className="space-y-2">
              <Button variant="outline" className="w-full bg-transparent" asChild>
                <Link href="/auth/volunteer">Tình nguyện viên</Link>
              </Button>
              <Button variant="outline" className="w-full bg-transparent" asChild>
