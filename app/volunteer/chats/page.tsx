...
export default function VolunteerChatsPage() {
  ...
  const programsWithChat = approvedRegistrations.map((reg) => {
    ...
    return (
      <div className="min-h-screen flex flex-col bg-background">
        ...
        <main className="flex-1 container mx-auto px-4 py-12">
          <p className="text-muted-foreground">Vui lòng đăng nhập với tài khoản tình nguyện viên</p>
        </main>
        <Footer />
      </div>
    )
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          {programsWithChat.length === 0 ? (
            <Card className="p-12 text-center border-0 bg-white/80 backdrop-blur-sm shadow-xl">
              ...
              <h3 className="text-xl font-bold text-foreground mb-2">Chưa có tin nhắn</h3>
              <p className="text-muted-foreground mb-6">
                Bạn cần được phê duyệt vào ít nhất một chương trình để có thể nhắn tin
              </p>
              ...
              <div className="lg:col-span-1">
                <Card className="p-4 border-0 bg-white/80 backdrop-blur-sm shadow-xl">
                  ...
                  <div className="space-y-2">
                    {programsWithChat.map((program) => program && (
                      <button
                        key={program.id}
                        ...
                        className={`w-full text-left p-3 rounded-lg transition-all duration-200 ${
                          selectedProgramId === program.id
                            ...
                            : "bg-muted hover:bg-emerald-50 border-2 border-transparent"
                        }`}
                      >
              ...
              <div className="lg:col-span-3">
                <Card className="border-0 bg-white/80 backdrop-blur-sm shadow-xl h-[600px] flex flex-col">
                  ...
                  <div className="p-6 border-b border-border/50">
                    <h2 className="text-xl font-bold text-foreground">{selectedProgram?.name}</h2>
                      ...
                      messages.map((msg) => (
                        ...
                        >
                          ...
                          >
                            ...
                            <p className={`text-xs mt-2 ${msg.userRole === "volunteer" ? "text-emerald-100" : "text-muted-foreground"}`}>
                  ...
                  <div className="p-6 border-t border-border/50">
                    <form onSubmit={handleSendMessage} className="flex gap-3">
                      <input
                        ...
                        className="flex-1 px-4 py-3 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-600"
                      />
                      <Button 
                        type="submit" 
